...
export const CONTENT: Record<Lang, CalContent> = {
  ...
  zh: {
    ...
    hero: {
      ...
      title: '为未来公共系统设计',
      titleAccent: '制度架构',
      body: '赛域公共制度架构实验室由未来公民署支持，面向政府、公共机构与特殊辖区，设计可信数字公共基础设施、数字身份体系和能够长期运行的公共制度能力。',
      ctaPrimary: '政府与机构接洽',
      ctaSecondary: '查看能力',
    },
    whatWeDo: {
      ...
      body: '赛域实验室关注的不是某个单一产品，而是可信公共系统得以成立的制度框架、运行规则与基础设施。我们在技术建设之前进入项目，先澄清公共授权、身份体系、服务边界、证据记录与监督机制，使系统从一开始就具备合法性、可问责性和长期运行能力。',
      not: '我们不交付孤立软件，也不做短期包装。赛域实验室的工作，是把公共目标转化为能够被授权、被建设、被监督的制度基础设施。',
    },
    capabilities: {
      eyebrow: '能力',
      title: '赛域实验室的设计能力',
      intro: '六项能力围绕同一条制度主线展开：先确认授权与政策目标，再设计身份、服务、证据和监督，最终形成可信、可治理的数字公共基础设施。',
      items: [
        {
          slug: 'government-advisory',
          title: '政府与机构设计顾问',
    ...
    insights: {
      eyebrow: '洞察',
      title: '关于未来公共系统的研究',
      body: '围绕制度设计、数字公共基础设施、特殊辖区与可信公共系统，持续形成可审阅的分析、工作笔记和方法框架。',
      topics: ['制度设计', '数字公共基础设施', '特殊辖区', '可信身份', '政策与监管', '数字居留'],
    },
    contact: {
      eyebrow: '联系',
      title: '政府与机构正式接洽',
      body: '赛域公共制度架构实验室接受政府、公共机构与特殊辖区的正式合作接洽。凡涉及制度设计、可信身份、数字公共基础设施或长期公共系统建设的项目，可通过正式渠道联系。',
      enquiryTitle: '接洽类别',
    ...
    closing: {
      eyebrow: '与赛域实验室合作',
      title: '共同设计可信公共系统',
      body: '赛域公共制度架构实验室与政府、公共机构和特殊辖区合作，将复杂公共愿景转化为可授权、可建设、可监督并可长期运行的制度基础设施。',
      ctaPrimary: '政府与机构接洽',
