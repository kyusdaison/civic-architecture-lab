...
export const CONTENT: Record<Lang, CalContent> = {
  ...
  zh: {
    ...
    hero: {
      ...
      title: '设计未来公共系统的',
      titleAccent: '制度架构',
      body: '赛域公共制度架构实验室由未来公民署支持，面向政府、公共机构与特殊辖区，设计可信数字公共基础设施、数字身份体系和面向未来的公共制度能力。',
      ctaPrimary: '政府与机构接洽',
      ctaSecondary: '查看能力',
    },
    whatWeDo: {
      eyebrow: '我们是什么',
      title: '制度设计实验室，而非普通咨询机构',
      body: '赛域实验室面向可信公共系统，设计其背后的制度框架、运行规则与数字公共基础设施。我们从技术建设之前开始工作，先明确公共授权、身份体系、服务边界、证据记录与监督机制，使系统从一开始就具备合法性、可问责性和长期运行能力。',
      not: '它不是软件供应商，也不是一般咨询公司；它是一套面向公共系统的制度设计与数字公共基础设施能力。',
    },
    capabilities: {
      eyebrow: '能力',
      title: '赛域实验室的设计能力',
      intro: '六项能力，贯穿同一条制度逻辑：从公共授权、政策框架到可信数字公共基础设施。',
      items: [
        {
          slug: 'government-advisory',
          title: '政府与机构顾问',
          text: '为推进公共系统现代化的政府、公共机构与特殊辖区提供战略和制度层面的设计支持。',
          lead: '为推进公共系统现代化的政府、公共机构与特殊辖区提供战略和制度层面的设计支持——从最初授权到运行模式。',
          includes: ['界定公共授权与政策目标', '评估机构就绪度与关键差距', '协调发起机构与相关利益方', '形成从概念到受治理项目的路线图'],
          outcomes: ['清晰且合法的公共授权', '对齐的机构责任与发起机制', '现实可执行的实施路径'],
        },
        {
          slug: 'institutional-design',
          title: '制度设计',
          text: '设计数字公共系统赖以运行的授权结构、机构职责与可问责治理。',
          lead: '设计数字公共系统赖以运行的制度基础、授权结构、机构职责与可问责治理。',
          includes: ['公共授权与权限结构', '公共服务机构设计', '角色、权利与问责模型', '监督与复核机制'],
        ...
        },
        {
          ...
          includes: ['可信数字身份框架', '受治理的服务访问入口', '可审阅的记录与证据层', '互操作性与数据本地化设计'],
          outcomes: ['身份能够被可靠识别', '服务能够被有序访问', '信任能够被验证和复核'],
        },
        {
          slug: 'special-jurisdiction-frameworks',
          title: '特殊辖区框架',
          ...
          outcomes: ['稳固且可解释的法律边界', '受控、分阶段的推进机制', '保留主权监督和公共责任'],
        },
        {
          slug: 'digital-residency-models',
          title: '数字居留模型',
          ...
          outcomes: ['合法且有边界的数字参与', '可携带、可验证的凭证体系', '监督机制内建于设计'],
        },
        {
          slug: 'policy-regulatory-frameworks',
          title: '政策与监管框架',
    ...
    approach: {
      ...
      steps: [
        ...
        { step: '02', title: '制度设计', text: '设计系统赖以运行的制度结构、身份模型、服务规则与证据边界。' },
        { step: '03', title: '数字公共基础设施', text: '在公共监督下，把制度设计转化为可信身份、服务访问与证据基础设施。' },
        { step: '04', title: '运行与管护', text: '作为长期制度伙伴，支持采用、治理、复核与持续管护。' },
      ],
    },
    govValue: {
      eyebrow: '公共价值',
      title: '为公共系统建设能力，而非投机',
      body: '赛域实验室帮助辖区建设可持续的公共系统能力。真正的价值来自更清晰的制度、更顺畅的服务、更可审阅的记录和更稳健的监督，而不是短期投机性收益。',
      points: [
        { title: '行政现代化', text: '通过结构化的数字系统降低摩擦、实现公共行政现代化。' },
        { title: '可持续参与模型', text: '设计合法的参与与服务模型，在传统税收之外形成可治理的公共价值来源。' },
    ...
    insights: {
      eyebrow: '洞察',
      title: '关于未来公共系统的研究',
      body: '围绕制度设计、数字公共基础设施、特殊辖区与可信公共系统，持续形成分析、工作笔记与标准方法。',
      topics: ['制度设计', '数字公共基础设施', '特殊辖区', '可信身份', '政策与监管', '数字居留'],
    },
    contact: {
      eyebrow: '联系',
      title: '政府与机构接洽',
      body: '赛域公共制度架构实验室面向政府、公共机构和特殊辖区开展合作。涉及制度设计、可信身份与数字公共基础设施的正式项目，可通过以下渠道联系。',
      enquiryTitle: '接洽类别',
    ...
    closing: {
      eyebrow: '与赛域实验室合作',
      title: '共同设计可信公共系统',
      body: '赛域公共制度架构实验室与政府、公共机构和特殊辖区合作，将复杂的公共愿景转化为可授权、可建设、可监督、可长期运行的制度基础设施。',
      ctaPrimary: '政府与机构接洽',
