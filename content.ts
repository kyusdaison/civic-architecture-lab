...
export const CONTENT: Record<Lang, CalContent> = {
  ...
  zh: {
    brand: { name: '公共制度架构实验室', tagline: '制度设计与数字公共基础设施', poweredBy: '由未来公民署支持' },
    nav: [
      { label: '首页', to: '/' },
    ...
    hero: {
      ...
      title: '设计未来公共系统的',
      titleAccent: '制度架构',
      body: '公共制度架构实验室是由未来公民署支持的制度设计能力。它与政府、公共机构和特殊辖区合作，设计数字公共基础设施、可信身份系统，以及面向未来的公民制度。',
      ctaPrimary: '政府与机构咨询',
      ctaSecondary: '查看能力',
    },
    whatWeDo: {
      ...
      body: 'CAL 设计可信公共系统背后的制度、框架与数字公共基础设施。我们工作在技术的上游——界定授权、身份、服务、证据与监督——使最终建成的系统合法、可问责且持久。',
    ...
    govValue: {
      ...
      body: 'CAL 帮助辖区建设持久的公共系统能力。价值来自更好的制度与服务——可持续的参与模型、更低的行政摩擦与更强的监督——而非投机性回报。',
      points: [
    ...
    contact: {
      eyebrow: '联系',
      title: '政府与机构咨询',
      body: '公共制度架构实验室与政府、公共机构和特殊辖区合作。制度设计与数字公共基础设施相关合作，欢迎联系。',
      enquiryTitle: '咨询类别',
    ...
    closing: {
      eyebrow: '与 CAL 合作',
      title: '共同设计可信的公共系统',
      body: '公共制度架构实验室与政府、公共机构和特殊辖区合作，设计未来公共系统的制度架构。',
      ctaPrimary: '政府与机构咨询',
      ctaSecondary: '返回 FCB 生态',
    },
    footer: { poweredBy: '公共制度架构实验室 —— 由未来公民署支持', ecosystem: 'FCB 生态', rights: '公共制度架构实验室' },
  },
};
